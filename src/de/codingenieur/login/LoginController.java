...
import de.codingenieur.dbUtil.Database;
import de.codingenieur.model.PopupWindow;
import de.codingenieur.model.ToolTipWindow;
...
public class LoginController implements Initializable {
	...
	public void succusLogin() {
		try {
			...
			Pane root = (Pane)fxmlLoader.load(getClass().getResource("/de/codingenieur/kontakt/kontakt.fxml").openStream());
